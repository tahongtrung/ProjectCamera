<div id="header">
    <div id="info_admin" style="margin-left: 30px;">
        ...
        <div id="avartar" style="float: left; width: 40px; height: 40px;">
            <img src="{!!asset('source/admin/')!!}/{!!Auth::user()->UrlHinh!!}" style="margin-top: 5px; border: 1px solid; border-radius: 20px 20px 20px 20px;width: 40px; height: 40px;" alt="" />
        </div>
        <!--ten admin-->
        ...
        <div id="menu_logout">
            <ul>
                ...
                <li>
                    <a href="{{route('dangxuatadmin')}}"><i class="fa fa-sign-out" aria-hidden="true"></i>&nbsp Đăng xuất</a>
                </li>
            </ul>
        </div>
    </div>
